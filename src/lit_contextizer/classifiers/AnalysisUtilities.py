...
def include_annotations_in_insider_corpus(insider_df, features_df):
    ...
    annotated_features_df = features_df_copy[~(features_df_copy.annotation & (features_df_copy.sent_dist == 0))].drop_duplicates()
    ...
    annotated_features_df["is_closest_cont_by_sent"] = (annotated_features_df['sent_dist'] == annotated_features_df['min_sent_dist'])
